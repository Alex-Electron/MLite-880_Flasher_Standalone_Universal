...
### Added
- Added new firmware: **MLite880_v1.57_20260608.bin**.

### Changed
- Bumped script version to **2.5.0** in `flash_MLite880.sh`, `flash_MLite880.bat`, `README.md`, and `README_RU.md`.
...
### Added
- Added new firmware: **MLite880_v1.56_20260602.bin**.

### Changed
- Bumped script version to **2.4.0** in `flash_MLite880.sh` and `flash_MLite880.bat`.
